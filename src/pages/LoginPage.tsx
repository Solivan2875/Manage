            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-600 to-teal-800 p-12 flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-xl text-teal-100 max-w-md leading-relaxed">
                        Organize suas ideias, gerencie suas tarefas e nunca perca uma anotação importante.
                    </p>
                </div>
                ...
                <div className="relative z-10 space-y-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Notas Inteligentes</h3>
                            <p className="text-teal-100 text-sm">Capture ideias rapidamente com formatação rica</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Calendário Integrado</h3>
                            <p className="text-teal-100 text-sm">Gerencie eventos e compromissos</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h3 className="text-white font-semibold mb-1">Sincronização Offline</h3>
                            <p className="text-teal-100 text-sm">Acesse suas notas mesmo sem internet</p>
                        </div>
                    </div>
                </div>
